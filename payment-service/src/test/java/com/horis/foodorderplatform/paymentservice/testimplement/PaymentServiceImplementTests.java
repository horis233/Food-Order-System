package com.horis.foodorderplatform.paymentservice.testimplement;

import com.horis.foodorderplatform.paymentservice.domain.CreditCardInfo;
import com.horis.foodorderplatform.paymentservice.domain.Order;
import com.horis.foodorderplatform.paymentservice.domain.Payment;
import com.horis.foodorderplatform.paymentservice.repository.OrderRepository;
import com.horis.foodorderplatform.paymentservice.repository.PaymentRepository;
import com.horis.foodorderplatform.paymentservice.service.implement.PaymentServiceImplement;
...
public class PaymentServiceImplementTests {
    ...
    public void setMock() {
        ...
        paymentService = new PaymentServiceImplement(restTemplate, orderRepository, paymentRepository);
